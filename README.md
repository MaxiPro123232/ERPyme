...
|---|---|
| `ERPyME.sln` | Solución de Visual Studio (proyecto ERPyME.WinForms) |
| `ERPyME.WinForms/` | Aplicación principal: WinForms + EF Core con arquitectura MVC |
| `Base de datos.sql` | Script SQL con el esquema oficial de la base `ERPyME` |
| `ERPyME/` | Versión WPF anterior (solo de referencia, no forma parte de la solución) |
| `wordsproyecto/` | Documentación de requerimientos del TP |
| `imagenes tp/` | Prototipos de interfaz de las pantallas |
| `Especificaciones ERPyME.docx` | Especificación técnica y funcional del sistema |
